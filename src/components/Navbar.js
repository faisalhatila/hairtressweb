...
const Navbar = () => {
    ...
    const handleClick = () => {
        if (!mobNav) {
            ...
            document.getElementById("mobile-body-overlay").classList.remove("d-block");
    ...
    return (
        <div className="navbarThirdRowContainer">
            <div id="navBarThirdRow" className="align-items-center navbarThirdRow row justify-content-between">
                <div id="mobileNavHeader1" className="navbarThirdRowCol1 col-11 col-lg-2 pl-lg-0 pt-3 pb-3">
                    <div className="d-flex">
                        <img src="assets/img/relevant/navbar/toggle.svg" className="d-none d-md-block mr-5" />
                        <Link to="/">
                ...
                <div className="navbarThirdRowCol2">
                    ...
                    <div className="pt-2 pb-0 pb-md-4">
                        <nav id="nav-menu-container" style={{ transform: "translateX(-50px)" }}>
                            <ul class="nav-menu">
          ...
          >
            {token && myData ? myData.userFirstName : "Login"} |
                    ...
                    {token && myData ? (
                        <Link to="/profile">
                            <label style={{ fontWeight: 900, color: "#fff", cursor: "pointer" }} className="noMarginBottom">
                    ...
                    {!token ? (
                        <Link to="/sign-up">
                            <label style={{ fontWeight: 900, color: "#F1AF43", cursor: "pointer" }} className="noMarginBottom">
                                &nbsp;SIGNUP
                            </label>
                        </Link>
                    ) : (
                        <label
                            style={{ fontWeight: 900, color: "#F1AF43", cursor: "pointer" }}
                            className="noMarginBottom"
